...
export function AppHeader() {
  ...
  return (
    <View className="border-b border-line bg-canvas">
      <View
        className="h-[60px] w-full flex-row items-center justify-between self-center px-md"
        style={{ maxWidth: MaxContentWidth }}>
        <View className="flex-1 flex-row items-center gap-xs">
          <View className="flex-row items-center gap-xxs">
            <Text className="text-label-md font-bold text-brand">가족e음</Text>
            <View className="rounded-full bg-success-soft px-xs py-[2px]">
          ...
          <Pressable
            ...
            className="h-[34px] max-w-[170px] flex-row items-center gap-xxs rounded bg-ice px-xs active:opacity-70">
        ...
        <View className="flex-row items-center gap-xs">
          <Pressable
            ...
            className="h-[44px] w-[44px] items-center justify-center rounded-full active:bg-ice">
